...
-- -----------------------------------------------------
-- Table `Ayx14res`.`Res14sal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Ayx14res`.`Res14sal` ;

CREATE TABLE IF NOT EXISTS `Ayx14res`.`Res14sal` (
  `R1SAL001` INT NOT NULL AUTO_INCREMENT,
  `R1SAL002` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`R1SAL001`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Ayx14res`.`Res14tab` (
  ...
  `R1TAB002` TINYINT(1) NOT NULL DEFAULT 0,
  `R1TAB003` TINYINT(1) NOT NULL DEFAULT 0,
  `R1TAB004` TINYINT(1) NOT NULL DEFAULT 0,
  `R1TAB005` TINYINT(1) NOT NULL DEFAULT 0,
  `Res14sal_R1SAL001` INT NOT NULL,
  PRIMARY KEY (`R1TAB000`),
  CONSTRAINT `fk_Res14tab_Res14sal1`
    FOREIGN KEY (`Res14sal_R1SAL001`)
    REFERENCES `Ayx14res`.`Res14sal` (`R1SAL001`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_Res14tab_Res14sal1_idx` ON `Ayx14res`.`Res14tab` (`Res14sal_R1SAL001` ASC);
...
-- -----------------------------------------------------
-- Table `Ayx14res`.`Res14cnt_BILL`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Ayx14res`.`Res14cnt_BILL` ;

CREATE TABLE IF NOT EXISTS `Ayx14res`.`Res14cnt_BILL` (
  `idRes14cnt_BILL` INT NOT NULL AUTO_INCREMENT,
  `line` VARCHAR(45) NOT NULL,
  `valueLine` VARCHAR(45) NULL,
  `version` INT NOT NULL,
  `paramCode` VARCHAR(11) NULL,
  PRIMARY KEY (`idRes14cnt_BILL`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Ayx14res`.`Res14mes_1` (
  ...
  `Res14tab_R1TAB000` INT NOT NULL,
  ...
  CONSTRAINT `fk_Res14mes_1_Res14mes1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Res14mes_1_Res14tab1`
    FOREIGN KEY (`Res14tab_R1TAB000`)
    REFERENCES `Ayx14res`.`Res14tab` (`R1TAB000`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_Res14mes_1_Res14tab1_idx` ON `Ayx14res`.`Res14mes_1` (`Res14tab_R1TAB000` ASC);
...
CREATE INDEX `fk_Res14mes_2_Res14cnt_CF1_idx` ON `Ayx14res`.`Res14mes_2` (`Res14cnt_CF_RCCNTR00` ASC);


-- -----------------------------------------------------
-- Table `Ayx14res`.`Res14mes_3`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Ayx14res`.`Res14mes_3` ;

CREATE TABLE IF NOT EXISTS `Ayx14res`.`Res14mes_3` (
  `R1MES000_3` INT NOT NULL AUTO_INCREMENT,
  `R1MES014` DECIMAL(11,2) NOT NULL,
  `R1MES019` DECIMAL(11,2) NOT NULL,
  `R1MES020` DECIMAL(11,2) NOT NULL,
  `Res14mes_1_R1MES000_1` INT NOT NULL,
  `Res14cnt_FP_RFCNT300` INT NOT NULL,
  PRIMARY KEY (`R1MES000_3`),
  CONSTRAINT `fk_Res14mes_3_Res14mes_11`
    FOREIGN KEY (`Res14mes_1_R1MES000_1`)
    REFERENCES `Ayx14res`.`Res14mes_1` (`R1MES000_1`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Res14mes_3_Res14cnt_FP1`
...
CREATE INDEX `fk_Res14mes_3_Res14mes_11_idx` ON `Ayx14res`.`Res14mes_3` (`Res14mes_1_R1MES000_1` ASC);

CREATE INDEX `fk_Res14mes_3_Res14cnt_FP1_idx` ON `Ayx14res`.`Res14mes_3` (`Res14cnt_FP_RFCNT300` ASC);
...
CREATE TABLE IF NOT EXISTS `Ayx14res`.`Res14res` (
  ...
  CONSTRAINT `fk_Res14res_Res14cli1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Res14res_Res14tab1`
    FOREIGN KEY (`Res14tab_R1TAB000`)
    REFERENCES `Ayx14res`.`Res14tab` (`R1TAB000`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_Res14res_Res14tab1_idx` ON `Ayx14res`.`Res14res` (`Res14tab_R1TAB000` ASC);
...
CREATE TABLE IF NOT EXISTS `Ayx14res`.`Res14ses_1` (
  ...
  CONSTRAINT `fk_Res14ses_1_Res14cli1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Res14ses_1_Res14tab1`
    FOREIGN KEY (`Res14tab_R1TAB000`)
    REFERENCES `Ayx14res`.`Res14tab` (`R1TAB000`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_Res14ses_1_Res14tab1_idx` ON `Ayx14res`.`Res14ses_1` (`Res14tab_R1TAB000` ASC);


-- -----------------------------------------------------
-- Table `Ayx14res`.`Res14ses_3`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Ayx14res`.`Res14ses_3` ;

CREATE TABLE IF NOT EXISTS `Ayx14res`.`Res14ses_3` (
  `R2SES000_4` INT NOT NULL,
  `R2SES017` DECIMAL(11,2) NOT NULL,
  `R2SES018` DECIMAL(11,2) NOT NULL,
  `R2SES019` DECIMAL(11,2) NOT NULL,
  `R2SES022` CHAR NOT NULL,
  `Res14ses_1_R2SES000_1` BIGINT NOT NULL,
  `Res14cnt_FP_RFCNT300` INT NOT NULL,
  PRIMARY KEY (`R2SES000_4`),
  CONSTRAINT `fk_Res14ses_3_Res14ses_11`
    FOREIGN KEY (`Res14ses_1_R2SES000_1`)
    REFERENCES `Ayx14res`.`Res14ses_1` (`R2SES000_1`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Res14ses_3_Res14cnt_FP1`
    FOREIGN KEY (`Res14cnt_FP_RFCNT300`)
    REFERENCES `Ayx14res`.`Res14cnt_FP` (`RFCNT300`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_Res14ses_3_Res14ses_11_idx` ON `Ayx14res`.`Res14ses_3` (`Res14ses_1_R2SES000_1` ASC);

CREATE INDEX `fk_Res14ses_3_Res14cnt_FP1_idx` ON `Ayx14res`.`Res14ses_3` (`Res14cnt_FP_RFCNT300` ASC);
